  ...
  return (
    <div className="w-screen px-20 absolute flex items-center bg-transparent h-1/5 left-0 right-0 ml-auto mr-auto">
      ...
      <div className="flex ml-auto text-xl gap-10">
        <button className="text-white font-medium p-2 rounded-lg hover:bg-primary hover:relative hover:-translate-y-1 hover:shadow-[0px_0px_20px_8px_rgba(251,_3,_143,_0.25)] transition-all ease-out duration-75">
          Alumnos
        </button>
        <button
