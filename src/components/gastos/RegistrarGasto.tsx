...
function RegistrarClase({
  ...
  const [minDate, setMinDate] = useState(
    convertirAStringFecha(new Date(), "fr-CA")
  );
      ...
      <div className="flex flex-col w-3/4">
        ...
        <div className="flex justify-center items-center mt-3">
          ...
          <Modal
            ...
            className="relative bg-white p-6 w-full max-w-xl min-h-min rounded-md text-black"
          >
            <h1 className="text-xl">
              ¿Estás seguro de que deseas registrar el siguiente pago?
            </h1>
            {formData && (
              <div className="mt-4">
                <p>
                  <strong>Monto:</strong> {formData.monto}
                </p>
                <p>
