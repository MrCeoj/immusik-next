import { obtenerClase } from '@/business/ClaseDelegate'
import { NextApiRequest, NextApiResponse } from 'next'

/**
 * Maneja la solicitud HTTP para obtener una clase.
 * @author Stiven
 ...
 * @returns - El resultado de la clase.
 */
export default async function handler(
	...
	try {
		...
		const result = await obtenerClase(Number(id))
